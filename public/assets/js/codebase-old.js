...
var Codebase = function () {
  var lHtml, lBody, lPage, lSidebar, lSidebarScroll, lSideOverlay, lSideOverlayScroll, lHeader, lHeaderSearch, lHeaderSearchInput, lHeaderLoader, lMain, lFooter, windowW; // Set helper variables
  ...
  var uiHandleScroll = function uiHandleScroll(mode) {
    windowW = getWidth(); // Init scrolling

    if (mode === 'init') {
      var sScrollTimeout; // Unbind events in case they are already binded

      jQuery(window).off('resize.cb.scroll orientationchange.cb.scroll'); // Bind the events
      ...
      if (windowW > 991 && lPage.hasClass('side-scroll')) {
        ...
        jQuery(lSidebar).add(lSideOverlay).scrollLock('disable'); // If sidebar scrolling does not exist init it..
        ...
        if (lSidebarScroll.length && !lSidebarScroll.parent('.slimScrollDiv').length) {
          ...
          lSidebarScroll.add(lSidebarScroll.parent()).css('height', lSidebar.outerHeight()); // Small hack, so that scrolling works if the mouse is over the scrolling area on load and hasn't moved yet
        ...
        jQuery(lSidebar).add(lSideOverlay).scrollLock('enable'); // If sidebar scrolling exists destroy it..
    ...
    if (lMain.length) {
      jQuery(window).on('resize.cb.main orientationchange.cb.main', function () {
        ...
        resizeTimeout = setTimeout(function () {
          ...
          var hFooter = lFooter.outerHeight() || 0; // Set #main-container min height accordingly
  ...
  var uiHandleNav = function uiHandleNav() {
    // Unbind event in case it is already enabled
    lPage.off('click.cb.menu'); // When a submenu link is clicked

    lPage.on('click.cb.menu', '[data-toggle="nav-submenu"]', function (e) {
      // Get link
      var link = jQuery(this); // Get link's parent
  ...
  var uiHandleTheme = function uiHandleTheme() {
    ...
    var cookies = lPage.hasClass('enable-cookies') ? true : false; // If cookies are enabled
    ...
    lPage.off('click.cb.themes'); // When a color theme link is clicked

    lPage.on('click.cb.themes', '[data-toggle="theme"]', function () {
      var themeName = jQuery(this).data('theme'); // Set this color theme link as active
      ...
      uiHandleThemeChange(themeEl, themeName); // Update theme element
  ...
  var uiApiLayout = function uiApiLayout(mode) {
    windowW = getWidth(); // Mode selection

    switch (mode) {
      case 'init':
        // Unbind event in case it is already enabled
        lPage.off('click.cb.layout'); // Call layout API on button click
      ...
      case 'header_search_on':
        ...
        lHeaderSearchInput.focus(); // When ESCAPE key is hit close the search section
      ...
      case 'header_search_off':
        ...
        lHeaderSearchInput.blur(); // Unbind ESCAPE key
  ...
  var uiApiBlocks = function uiApiBlocks(block, mode) {
    ...
    if (mode === 'init') {
      ...
      lPage.off('click.cb.blocks'); // Call blocks API on option button click
      ...
      // Get block element
      var elBlock = block instanceof jQuery ? block : jQuery(block); // If element exists, procceed with blocks functionality

      if (elBlock.length) {
        // Get block option buttons if exist (need them to update their icons)
        var btnFullscreen = jQuery('[data-toggle="block-option"][data-action="fullscreen_toggle"]', elBlock);
        var btnContentToggle = jQuery('[data-toggle="block-option"][data-action="content_toggle"]', elBlock); // Mode selection
  ...
  var uiHelperCoreToggleClass = function uiHelperCoreToggleClass() {
    jQuery('[data-toggle="class-toggle"]:not(.js-class-toggle-enabled)').on('click.cb.helpers.core', function () {
      var el = jQuery(this); // Add .js-class-toggle-enabled class to tag it as activated
  ...
  var uiHelperCoreScrollTo = function uiHelperCoreScrollTo() {
    jQuery('[data-toggle="scroll-to"]:not(.js-scroll-to-enabled)').on('click.cb.helpers.core', function (e) {
      ...
      var headerHeight = lHeader.length && lPage.hasClass('page-header-fixed') ? lHeader.outerHeight() : 0; // Add .js-scroll-to-enabled class to tag it as activated
  ...
  var uiHelperCoreTooltip = function uiHelperCoreTooltip() {
    jQuery('[data-toggle="tooltip"]:not(.js-tooltip-enabled)').add('.js-tooltip:not(.js-tooltip-enabled)').each(function () {
      var el = jQuery(this); // Add .js-tooltip-enabled class to tag it as activated

      el.addClass('js-tooltip-enabled'); // Init
  ...
  var uiHelperCorePopover = function uiHelperCorePopover() {
    jQuery('[data-toggle="popover"]:not(.js-popover-enabled)').add('.js-popover:not(.js-popover-enabled)').each(function () {
      var el = jQuery(this); // Add .js-popover-enabled class to tag it as activated

      el.addClass('js-popover-enabled'); // Init
  ...
  var uiHelperCoreTab = function uiHelperCoreTab() {
    jQuery('[data-toggle="tabs"]:not(.js-tabs-enabled)').add('.js-tabs:not(.js-tabs-enabled)').each(function () {
      var el = jQuery(this); // Add .js-tabs-enabled class to tag it as activated

      el.addClass('js-tabs-enabled'); // Init
  ...
  var uiHelperCoreAppear = function uiHelperCoreAppear() {
    ...
    jQuery('[data-toggle="appear"]:not(.js-appear-enabled)').each(function () {
      ...
      var elTimeout = lHtml.hasClass('ie9') || windowW < 992 ? 0 : el.data('timeout') ? el.data('timeout') : 0; // Add .js-appear-enabled class to tag it as activated

      el.addClass('js-appear-enabled'); // Init
  ...
  var uiHelperCoreAppearCountTo = function uiHelperCoreAppearCountTo() {
    ...
    jQuery('[data-toggle="countTo"]:not(.js-count-to-enabled)').each(function () {
      ...
      var elBefore = el.data('before'); // Add .js-count-to-enabled class to tag it as activated

      el.addClass('js-count-to-enabled'); // Init
  ...
  var uiHelperCoreSlimscroll = function uiHelperCoreSlimscroll() {
    ...
    jQuery('[data-toggle="slimscroll"]:not(.js-slimscroll-enabled)').each(function () {
      var el = jQuery(this); // Add .js-slimscroll-enabled class to tag it as activated

      el.addClass('js-slimscroll-enabled'); // Init
  ...
  var uiHelperCoreRipple = function uiHelperCoreRipple() {
    jQuery('[data-toggle="click-ripple"]:not(.js-click-ripple-enabled)').each(function () {
      var el = jQuery(this); // Add .js-click-ripple-enabled class to tag it as activated

      el.addClass('js-click-ripple-enabled'); // Add required properties to the element
      ...
      el.on('click.cb.helpers.core', function (e) {
        ...
        var ripple = el.children('.' + cssClass); // If the ripple element doesn't have dimensions set them accordingly
  ...
  var uiHelperTableToolsSections = function uiHelperTableToolsSections() {
    ...
    jQuery('.js-table-sections:not(.js-table-sections-enabled)').each(function () {
      var table = jQuery(this); // Add .js-table-sections-enabled class to tag it as activated
  ...
  var uiHelperTableToolsCheckable = function uiHelperTableToolsCheckable() {
    ...
    jQuery('.js-table-checkable:not(.js-table-checkable-enabled)').each(function () {
      var table = jQuery(this); // Add .js-table-checkable-enabled class to tag it as activated
      ...
      jQuery('thead input:checkbox', table).on('click.cb.helpers', function () {
        var checkedStatus = jQuery(this).prop('checked'); // Check or uncheck all checkboxes in tbody
  ...
  var uiHelperMagnific = function uiHelperMagnific() {
    ...
    jQuery('.js-gallery:not(.js-gallery-enabled)').each(function () {
      var el = jQuery(this); // Add .js-gallery-enabled class to tag it as activated

      el.addClass('js-gallery-enabled'); // Init
  ...
  var uiHelperCkeditor = function uiHelperCkeditor() {
    ...
    if (jQuery('#js-ckeditor:not(.js-ckeditor-enabled)').length) {
      ...
      CKEDITOR.replace('js-ckeditor', {
        toolbar: [{
          name: 'document',
          items: ['Preview', 'Print', '-', 'Templates']
        }, {
          name: 'clipboard',
          items: ['Cut', 'Copy', 'SelectAll', 'Paste', '-', 'Undo', 'Redo']
        }, {
          name: 'editing',
          items: ['Find', 'Replace']
        }, {
      ...
      CKEDITOR.config.heigth = 1000; // CKEDITOR.config.removePlugins = "elementspath";
  ...
  var uiHelperSimpleMDE = function uiHelperSimpleMDE() {
    ...
    jQuery('.js-simplemde:not(.js-simplemde-enabled)').each(function () {
      var el = jQuery(this); // Add .js-simplemde-enabled class to tag it as activated
  ...
  var uiHelperSlick = function uiHelperSlick() {
    ...
    jQuery('.js-slider:not(.js-slider-enabled)').each(function () {
      var el = jQuery(this); // Add .js-slider-enabled class to tag it as activated

      el.addClass('js-slider-enabled'); // Init slick slider
  ...
  var uiHelperDatepicker = function uiHelperDatepicker() {
    ...
    jQuery('.js-datepicker:not(.js-datepicker-enabled)').add('.input-daterange:not(.js-datepicker-enabled)').each(function () {
      ...
      el.datepicker({
        ...
        todayHighlight: el.data('today-highlight') || true //orientation: 'bottom' // Position issue when using BS4, set it to bottom until officially supported
  ...
  var uiHelperColorpicker = function uiHelperColorpicker() {
    ...
    jQuery('.js-colorpicker:not(.js-colorpicker-enabled)').each(function () {
      var el = jQuery(this); // Add .js-enabled class to tag it as activated

      el.addClass('js-colorpicker-enabled'); // Init colorpicker
  ...
  var uiHelperTagsInputs = function uiHelperTagsInputs() {
    ...
    jQuery('.js-tags-input:not(.js-tags-input-enabled)').each(function () {
      var el = jQuery(this); // Add .js-tags-input-enabled class to tag it as activated

      el.addClass('js-tags-input-enabled'); // Init
  ...
  var uiHelperSelect2 = function uiHelperSelect2() {
    ...
    jQuery('.js-select2:not(.js-select2-enabled)').each(function () {
      var el = jQuery(this); // Add .js-select2-enabled class to tag it as activated

      el.addClass('js-select2-enabled'); // Init
  ...
  var uiHelperNotify = function uiHelperNotify() {
    ...
    jQuery('.js-notify:not(.js-notify-enabled)').each(function () {
      var el = jQuery(this); // Add .js-notify-enabled class to tag it as activated

      el.addClass('js-notify-enabled'); // Init on click

      el.on('click.cb.helpers', function () {
        var growl = jQuery(this); // Create notification
  ...
  var uiHelperDraggableItems = function uiHelperDraggableItems() {
    ...
    jQuery('.js-draggable-items:not(.js-draggable-items-enabled)').each(function () {
      var el = jQuery(this); // Add .js-draggable-items-enabled class to tag it as activated

      el.addClass('js-draggable-items-enabled'); // Init
  ...
  var uiHelperEasyPieChart = function uiHelperEasyPieChart() {
    ...
    jQuery('.js-pie-chart:not(.js-pie-chart-enabled)').each(function () {
      var el = jQuery(this); // Add .js-pie-chart-enabled class to tag it as activated

      el.addClass('js-pie-chart-enabled'); // Init
  ...
  var uiHelperMaxlength = function uiHelperMaxlength() {
    ...
    jQuery('.js-maxlength:not(.js-maxlength-enabled)').each(function () {
      ...
      var el = jQuery(this); // Add .js-maxlength-enabled class to tag it as activated

      el.addClass('js-maxlength-enabled'); // Init
      ...
      el.maxlength({
        ...
        message: el.data('message') || 'Restam %charsRemaining% de %charsTotal% dígitos.' //preText: el.data('pre-text') || '',
  ...
  var uiHelperRangeslider = function uiHelperRangeslider() {
    ...
    jQuery('.js-rangeslider:not(.js-rangeslider-enabled)').each(function () {
      var el = jQuery(this); // Add .js-rangeslider-enabled class to tag it as activated

      el.addClass('js-rangeslider-enabled'); // Init
  ...
  var uiHelperSummernote = function uiHelperSummernote() {
    // Init text editor in air mode (inline)
    jQuery('.js-summernote-air:not(.js-summernote-air-enabled)').each(function () {
      var el = jQuery(this); // Add .js-summernote-air-enabled class to tag it as activated

      el.addClass('js-summernote-air-enabled'); // Init
    ...
    jQuery('.js-summernote:not(.js-summernote-enabled)').each(function () {
      var el = jQuery(this); // Add .js-summernote-enabled class to tag it as activated

      el.addClass('js-summernote-enabled'); // Init
  ...
  return {
    init: function init() {
      ...
      uiApiLayout('init');
      uiApiBlocks(false, 'init'); // CORE HELPERS
    ...
    helpers: function helpers(_helpers) {
      if (_helpers instanceof Array) {
        for (var index in _helpers) {
          Codebase.helper(_helpers[index]);
        }
      } else {
        Codebase.helper(_helpers);
      }
    }
  };
...
/***/ 2:
/*!****************************************!*\
  !*** multi ./resources/js/codebase.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\wamp64\www\vuelyder\lyder\resources\js\codebase.js */"./resources/js/codebase.js");
